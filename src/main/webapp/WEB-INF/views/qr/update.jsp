      ...
      <div class="container4">
         ...
         <form name="frm" action="updateOk" method="post"
            ...
            <table>
               <tr>
                  <th>이름</th>
                  <td><input type="hidden" name="uid" value="${list[0].uid }" /><input type="text" name="name" value="${list[0].name }"/></td>
               </tr>
               <tr>
                  <th>카테고리</th>
               ...
               <tr>
                  <th>나이</th>
                  <td><input type="text" name="age" value="${list[0].age}" /></td>

               </tr>
               <tr>
                  <th>주소</th>
                  <td><input type="text" name=address  class="postcode" id="sample4_postcode"  value="${list[0].address}" ></td>
               ...
               <tr>
                  <th>도로명주소</th>
                  <td><input type="hidden" class="roadAddress"
                     id="sample4_roadAddress"  style="font-size:10pt;"></td>
               </tr>
         
               <tr>
                  <th>상세주소</th>
                  <td><input type="hidden"  name="Address" class="detailAddress"
...
<tr><th>
               <input type="hidden" class="extraAddress" id="sample4_extraAddress"  >
                 ...
                 <!-- <input type="hidden" name="address" id="address" class="address"
                  value="${list[0].address}" onkeyup='call()' />-->
                  <tr>
                  <th>보호자 전화번호</th>
                  <td><input type="text" name="phone" value="${list[0].phone}"/></td>
               </tr>
               <tr>
               <th>특이사항</th>
...
<button type="submit" class="button"  value="qr수정">QR수정 </button>  
<button onclick="history.back();" class="button">이전으로</button>      
               </form>
