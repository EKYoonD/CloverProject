...
<script>
    ...
    function checks() {
		...
		if (!getPhone.test($("#order_Phone").val())) {
			...
			<form action="orderOk" method="POST" class="orderForm"
				...
				<div class="textForm">
					수령인 :&nbsp;<input name="order_Rec" id="order_Rec" type="text"
						class="order_Rec" value="${k.order_Rec}" placeHolder="수령인을 입력해주세요"/>

				</div>
				<div class="textForm">
					연락처 :<input name="order_Phone" id="order_Phone" type="text"
						class="order_Phone" value="${k.order_Phone}" maxlength="11" placeholder="'-'를 제외하고 입력해주세요" />
				</div>
				...
				<div class="textForm">
					수&nbsp;&nbsp;&nbsp;량 :&nbsp;<input name="quantity" id="quantity" type="text" id="quantity"
						...
						onkeyup="sale_price(this.form)" placeHolder="수량을 입력해주세요"/> <input type="hidden"
				...
				<div class="textForm1">
					&nbsp;&nbsp;우편번호 : <input  type="text" class="postcode" id="sample4_postcode" placeHolder="우편번호를 입력해주세요">	
				...
				<div class="textForm">
					...
					<div class="textForm">
					상세주소 :&nbsp;<input type="text" name="Address" class="detailAddress" id="sample4_detailAddress" placeHolder="상세주소를 입력해주세요" >
				</div>
				<div class="textForm">
